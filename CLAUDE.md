...
## Social Media module (6th module) — Phase 1: WhatsApp inbox (2026-06-19) — DEPLOYED (Phase-A test wiring)
...
### Sub-products: explicit "Add sub-product" editor in the Products master (2026-06-23) — ✅ DEPLOYED (hosting-only, verify:deploy 3/3 green)
