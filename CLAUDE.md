...
**crm2 route groups extracted: whatsapp · connectorRoutes · mastersClients · queueRoutes · taskRoutes. crm2.ts 5721 → 3873 (~32% out).** Remaining non-money: **leads** (public intake · CRUD · convert · promote — verify convert doesn't touch payout). Then the money path one at a time (mappings/resolveMapping · cases · logins · disburse/payout-cycles · mis · recon · jobs).
