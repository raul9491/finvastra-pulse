...
export const NAV_NODES: NavNode[] = [
  ...
  { key: 'hrms.performance',      label: 'My Review',           route: '/hrms/performance',           module: 'hrms', icon: 'ClipboardCheck',      group: 'Growth',   access: hrms },
  ...
  { key: 'hrms.gen-payslips',     label: 'Generate Payslips',   route: '/hrms/admin/payslips',        module: 'hrms', icon: 'FileText',        group: 'Payroll & Compliance', access: hrmsAdmin },
  { key: 'hrms.admin-claims',     label: 'Claims — Admin',      route: '/hrms/admin/claims',          module: 'hrms', icon: 'ReceiptText',     group: 'Payroll & Compliance', access: hrmsAdmin },
  { key: 'hrms.claims-analytics', label: 'Claims Analytics',    route: '/hrms/admin/claims-analytics',module: 'hrms', icon: 'PieChart',      group: 'Payroll & Compliance', access: hrmsAdmin },
  { key: 'hrms.salary-history',   label: 'Salary History',      route: '/hrms/admin/salary-history',  module: 'hrms', icon: 'Banknote',      group: 'Payroll & Compliance', access: hrmsAdmin },
  { key: 'hrms.it-declarations',  label: 'IT Declarations',     route: '/hrms/admin/it-declarations', module: 'hrms', icon: 'FileSearch2',     group: 'Payroll & Compliance', access: hrmsAdmin },
  { key: 'hrms.letters',          label: 'HR Letters',          route: '/hrms/admin/letters',         module: 'hrms', icon: 'ScrollText',      group: 'Communications',  access: hrmsAdmin },
  { key: 'hrms.admin-documents',  label: 'Documents — Admin',   route: '/hrms/admin/documents',       module: 'hrms', icon: 'FolderOpen',      group: 'Communications',  access: hrmsAdmin },
  { key: 'hrms.admin-announce',   label: 'Announcements — Admin',route: '/hrms/admin/announcements',  module: 'hrms', icon: 'Megaphone',       group: 'Communications',  access: hrmsAdmin },
  { key: 'hrms.admin-perf',       label: 'Performance Reviews', route: '/hrms/admin/performance',     module: 'hrms', icon: 'Award',      group: 'Performance', access: hrmsAdmin },
  ...
  { key: 'hrms.helpdesk-admin',   label: 'HR Helpdesk — Admin', route: '/hrms/admin/hr-helpdesk',     module: 'hrms', icon: 'LifeBuoy',        group: 'People', access: hrmsAdmin },
  { key: 'hrms.compliance',       label: 'Compliance Calendar', route: '/hrms/admin/compliance',      module: 'hrms', icon: 'Building2',       group: 'Payroll & Compliance', access: hrmsAdmin },
  { key: 'hrms.pf-tracker',       label: 'PF Tracker',          route: '/hrms/admin/pf-tracker',      module: 'hrms', icon: 'Calculator',      group: 'Payroll & Compliance', access: hrmsAdmin },
  ...
  { key: 'crm.access-logs',       label: 'Access Logs',         route: '/crm/admin/access-logs',      module: 'crm', icon: 'ScrollText',        group: 'Admin',     access: crmAdmin },
  { key: 'crm.rtbf',              label: 'Right to Erasure',    route: '/crm/admin/right-to-be-forgotten', module: 'crm', icon: 'Trash2',   group: 'Admin',     access: crmAdmin },
  { key: 'crm.webhooks',          label: 'Webhooks',            route: '/crm/admin/webhooks',         module: 'crm', icon: 'Webhook',         group: 'Admin',     access: crmAdmin },

  // ════════════════════════════ MIS ════════════════════════════
  { key: 'mis.cases-mis',         label: 'Case Financials',                 route: '/mis/cases-mis',              module: 'mis', icon: 'FileSpreadsheet',       group: 'MIS',       access: misAll, end: true },
  ...
  { key: 'mis.payouts',           label: 'RM Payouts',          route: '/mis/payouts',                module: 'mis', icon: 'Banknote',     group: 'Archive · old MIS', access: misAdmin },
  { key: 'mis.commissions',       label: 'Commissions',         route: '/mis/commissions',            module: 'mis', icon: 'Wallet',     group: 'Archive · old MIS', access: misAdmin },
