...
export const SHAREABLE_PAGES = {
  ...
  'crm.crm2-dashboards':{ title: 'Analytics',              route: '/crm/pipeline/dashboards',    module: 'crm',  icon: 'BarChart2',       description: 'Funnel, pipeline, disbursement, payout health and RM scorecards.' },
