...
- **Remaining Phase 2 value is small and targeted:** adopt `leadModel` where a read is genuinely cross-model. The aggregation paths (`accumulatePerf`, activity summary) were already converted server-side on 2026-07-20.
