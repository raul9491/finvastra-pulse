...
**crm2 pure/foundation extraction is COMPLETE; route groups extracted: whatsapp · connectorRoutes · mastersClients · queueRoutes. crm2.ts 5721 → 4131 (~28% out).** Remaining non-money: **tasks · leads**. Then the money path one at a time (mappings/resolveMapping · cases · logins · disburse/payout-cycles · mis · recon · jobs).
