  ...
  return (
    <div>
      ...
      <button
        ...
        className="flex items-center gap-2 text-sm px-4 py-2 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        style={{ color: '#2A2A2A' }}
        title={
          !canGenerate && totalDocs > 0
