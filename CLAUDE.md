...
**crm2 route groups extracted (7). crm2.ts 5721 → 3148 (~45% out).** Remaining money-path (heaviest, one at a time, money gate each, STOP on any non-13/13): **cases · logins · disburse/payout-cycles · mis · recon · jobs.**
