...
### Sub-products are LENDER-specific (per product) — moved off the product (2026-06-23) — ✅ DEPLOYED TO PRODUCTION (rev `pulse-api-00071-9d7`, Cloud Run + hosting, verify:deploy 3/3 green)
