...
**crm2 route groups extracted (6): whatsapp · connectorRoutes · mastersClients · queueRoutes · taskRoutes · leadRoutes. crm2.ts 5721 → 3310 (~42% out).** **All non-money groups are done.** Remaining = the MONEY PATH, one at a time with the money gate on each: **mappings/resolveMapping · cases · logins · disburse/payout-cycles · mis · recon · jobs.** These are the financially-critical routes; go slowest here.
