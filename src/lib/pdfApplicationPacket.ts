...
function buildConsentPage(doc: JsPDFLike, data: PacketData, pageW: number): void {
  ...
  const disclaimer = [
    ...
    'Finvastra Advisors Private Limited is strictly prohibited.',
    '',
    'The information contained herein has been provided by the applicant and is believed to be accurate.',
    'Finvastra Advisors Private Limited does not warrant its completeness and bears no responsibility for',
